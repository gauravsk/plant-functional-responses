...
Here's some things that are yet to be done:   
 ...
 - [ ] Up the max replicates of model 5 from 100 to 200, to see if the few remaining species that don't converge eventually do (maybe this doesn't matter in the end, can't hurt to try.)  